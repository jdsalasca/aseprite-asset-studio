...
- `SPRITE EFFECTS` añade outline, color grade, sombra, partículas, normal map, lluvia, ciclos de movimiento, nearest upscale, seamless texture, reflejo animado y caústicas de agua con outputs separados.
