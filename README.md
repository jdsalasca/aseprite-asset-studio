...
- `SPRITE EFFECTS` añade outline, color grade, sombra, partículas, normal map, lluvia, ciclos de movimiento, nearest upscale, seamless texture y reflejo animado de agua con outputs separados.
