...
describe("studio feature contracts", () => {
  ...
  it("renders progress, searchable logs, tools and runtime metrics", () => {
    ...
    expect(effectsMarkup).toContain("DUST OVERLAY");
    expect(effectsMarkup).toContain("LEAF FALL OVERLAY");
    expect(effectsMarkup).toContain("WATER RIPPLE OVERLAY");
    ...
    const sceneStackMarkup = renderToStaticMarkup(<SceneEffectStackPanel busy={false} online assetName="oak.png" onGenerate={() => undefined} />);
      ...
      expect(sceneStackMarkup).toContain("DUST");
      expect(sceneStackMarkup).toContain("LEAF FALL");
      expect(sceneStackMarkup).toContain("RIPPLE");
