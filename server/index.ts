...
const setup = new ServerSetupService(new StdioMcpSessionAdapter(), new LocalMcpWorkspaceValidator(), new JsonStudioConfigStore(process.env.ASSET_STUDIO_CONFIG_PATH ?? join(process.cwd(), ".asset-studio", "config.json")));
