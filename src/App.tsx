...
export default function App() {
  const { config, status, tools, busy, assetName, assetPath, plan, previewUrl, enhancedPreviewUrl, notice, updateConfig, start, stop, inspect, applyPlan, upload } = useAssetStudioController();
