  ...
  return <main className="studio-shell">
    ...
    <div className="studio-grid">
      <div className="studio-main">
        ...
        <AssetLibraryPanel busy={busy} online={status.state === "online"} query={libraryQuery} items={assetLibrary?.items ?? []} presets={assetLibrary?.presets ?? []} total={assetLibrary?.total ?? 0} onQueryChange={updateLibraryQuery} onSearch={() => void searchAssetLibrary()} />
