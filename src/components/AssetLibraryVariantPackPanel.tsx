...
const supportedVariants: AssetVariantKind[] = ["rain", "fire", "earthquake", "birds", "night", "day_night", "walk", "water_reflection", "water_caustics", "wind_sway", "wind"];
...
export function AssetLibraryVariantPackPanel({ busy, online, result, previewUrl, onGenerate }: AssetLibraryVariantPackPanelProps) {
  ...
  return <PixelPanel title="LIBRARY VARIANT FACTORY" accent="amber">
    <p className="muted">Selecciona varios assets y genera lluvia, fuego, movimiento, viento, noche, aves, terremoto o reflejos con una sola operación. `wind` se conserva como alias de compatibilidad.</p>
