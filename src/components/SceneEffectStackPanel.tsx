...
import { PixelButton, PixelCheckboxGroup, PixelEffectStackPreview, PixelField, PixelPanel, PixelSelect } from "@jdsalasc/pixel-ui";
...
const OPTIONS: Array<{ value: SceneEffectKind; label: string }> = [
  { value: "material_texture", label: "MATERIAL GRAIN" }, { value: "depth_lighting", label: "DEPTH LIGHT" }, { value: "rain", label: "RAIN" }, { value: "wind_sway", label: "WIND SWAY" }, { value: "sprite_shadow", label: "SPRITE SHADOW" }, { value: "sprite_glow", label: "SPRITE GLOW" }, { value: "particles", label: "PARTICLES" }, { value: "water_reflection", label: "WATER REFLECTION" }, { value: "water_caustics", label: "WATER CAUSTICS" }, { value: "day_night", label: "DAY / NIGHT" },
];
