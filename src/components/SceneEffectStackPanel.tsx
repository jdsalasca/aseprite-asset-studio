...
const OPTIONS: Array<{ value: SceneEffectKind; label: string }> = [
  { value: "material_texture", label: "MATERIAL GRAIN" }, { value: "depth_lighting", label: "DEPTH LIGHT" }, { value: "rain", label: "RAIN" }, { value: "wind_sway", label: "WIND SWAY" }, { value: "particles", label: "PARTICLES" }, { value: "water_reflection", label: "WATER REFLECTION" }, { value: "water_caustics", label: "WATER CAUSTICS" }, { value: "day_night", label: "DAY / NIGHT" },
];
